...
type Choice = 'C1' | 'C2' | 'C3' | 'Blacklist' | 'Neutre';
...
const CHOICES: { key: Choice; klass: string; title: string; sub: string }[] = [
  ...
  { key: 'Neutre', klass: 'unknown', title: 'Neutre', sub: 'Sans classification' },
];
...
const CHOICE_LABELS: Record<Choice, string> = {
  ...
  Neutre: 'Neutre · Sans classification',
};
...
function choiceIcon(key: Choice) {
  ...
  if (key === 'Neutre') return <MinusCircle size={20} strokeWidth={3} />;
